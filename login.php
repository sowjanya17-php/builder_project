...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if($email && $password)
  {
	  $result_query = fetch_user($email,$password,$conn);
	  if($result_query)
	  {
		  header("Location:http://localhost/builder_proj/add_builder.php");
	  }else{
		  echo "unable to fetch the user.";
	  }
...
<h2 class="mb-5" style="text-align:center">Login </h2>
    <div class="card card0 border-0">
        ...
        Please choose a username.
					...
					<label> New User <b><a class="disabled-link" href="http://localhost/builder_proj/signup.php">Register</a> </b></label>
					<div class="mb-3 mt-4">
